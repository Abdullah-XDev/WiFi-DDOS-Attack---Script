...
print(r"""
 .----------------.  .----------------.  .----------------.  .----------------.  .----------------.  .----------------.  .----------------.  .----------------. 
| .--------------. || .--------------. || .--------------. || .--------------. || .--------------. || .--------------. || .--------------. || .--------------. |
| |  ________    | || |  ________    | || |     ____     | || |    _______   | || | _____  _____ | || |     _____    | || |  _________   | || |     _____    | |
| | |_   ___ `.  | || | |_   ___ `.  | || |   .'    `.   | || |   /  ___  |  | || ||_   _||_   _|| || |    |_   _|   | || | |_   ___  |  | || |    |_   _|   | |
| |   | |   `. \ | || |   | |   `. \ | || |  /  .--.  \  | || |  |  (__ \_|  | || |  | | /\ | |  | || |      | |     | || |   | |_  \_|  | || |      | |     | |
| |   | |    | | | || |   | |    | | | || |  | |    | |  | || |   '.___`-.   | || |  | |/  \| |  | || |      | |     | || |   |  _|      | || |      | |     | |
| |  _| |___.' / | || |  _| |___.' / | || |  \  `--'  /  | || |  |`\____) |  | || |  |   /\   |  | || |     _| |_    | || |  _| |_       | || |     _| |_    | |
| | |________.'  | || | |________.'  | || |   `.____.'   | || |  |_______.'  | || |  |__/  \__|  | || |    |_____|   | || | |_____|      | || |    |_____|   | |
| |              | || |              | || |              | || |              | || |              | || |              | || |              | || |              | |
| '--------------' || '--------------' || '--------------' || '--------------' || '--------------' || '--------------' || '--------------' || '--------------' |
 '----------------'  '----------------'  '----------------'  '----------------'  '----------------'  '----------------'  '----------------'  '----------------' 
""")
...
print(r"""
  ______          _       _____            _      _         
 |  ____|        | |     / ____|          (_)    | |        
 | |__ _   _  ___| | __ | (___   ___   ___ _  ___| |_ _   _ 
 |  __| | | |/ __| |/ /  \___ \ / _ \ / __| |/ _ \ __| | | |
 | |  | |_| | (__|   <   ____) | (_) | (__| |  __/ |_| |_| |
 |_|   \__,_|\___|_|\_\ |_____/ \___/ \___|_|\___|\__|\__, |
                                                       __/ |
                                                      |___/ 
""")
print("""
